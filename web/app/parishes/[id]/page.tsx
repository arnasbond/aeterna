...
export default function ParishHubPage() {
  ...
  if (!parish || err) {
    return (
      <HerculesPageShell narrow center title="Parapija nerasta">
      ...
      <div className={`hercules-page ${HERCULES_REVEAL}`}>
        <section className="ae-parish-hero">
          ...
          <div className="ae-parish-hero__body">
            ...
            <h1 className="chronicle-serif hercules-page__title">{parish.title}</h1>
            <p className="ae-parish-hero__meta">
              {parish.city && <span>{parish.city} · </span>}
              {parish.deaneryName}
            </p>
            <p className="ae-hint" style={{ marginBottom: "1.25rem" }}>
              {parish.supportGoal}
            </p>
            {parish.websiteUrl && (
        ...
        <div className="hercules-page__inner">
          <section id="profilis">
            <h2 className="hercules-page__title chronicle-serif" style={{ fontSize: "1.35rem" }}>
