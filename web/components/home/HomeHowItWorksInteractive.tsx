...
export function HomeHowItWorksInteractive() {
  ...
  return (
    <div className="ae-how-interactive">
      <div className="ae-how-interactive__steps">
        {STEPS.map((s, i) => (
          <button
            key={s.id}
            type="button"
            className={`ae-how-step ${HERCULES_FLOAT}${active === i ? " ae-how-step--active" : ""}`}
            onClick={() => setActive(i)}
      ...
      <div className={`ae-how-interactive__phone-wrap ${HERCULES_FLOAT} hercules-float--static !p-6`} aria-live="polite">
